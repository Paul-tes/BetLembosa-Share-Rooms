      ...
      <div className="flex items-center justify-between px-20">
        ...
        <form class="mx-auto w-1/3" onSubmit={handleSearch}>   
          ...
          <div class="relative">
              ...
              <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-betlembosa-theme-color hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
          </div>
        </form>
        )}
